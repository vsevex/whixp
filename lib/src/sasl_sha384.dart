...
/// mechanisms. This class specifically implements the `SCRAM-SHA-384`
/// mechanism, which is a SASL authentication mechanism that uses the `Secure
/// Hash Algorithm 384` (SHA-384) to provide message authentication.
class SASLSHA384 extends SASL {
  /// Constructs a new instance of the `SASLSHA384` class with the specified
  /// mechanism, client-first flag and priority.
  SASLSHA384(super.connection,{
    /// The SASL mechanism name
    super.name = 'SCRAM-SHA-384',
  ...
  /// the connection, the challenge, the hash algorithm (SHA-384), and the hash
  /// length (384 bits).
  @override
