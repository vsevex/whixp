...
/// The [SASLSHA1] class is a concrete implementation of the [SASL] abstract
/// class, which provides a framework for implementing different SASL
/// mechanisms. This class specifically implements the SCRAM-SHA-1 mechanism,
/// which is a SASL authentication mechanism that uses the `Secure Hash
/// Algorithm 1` (SHA-1) to provide message authentication.
class SASLSHA1 extends SASL {
  /// Constructs a new instance of the `SASLSHA1` class with the specified
  /// mechanism, client-first flag and priority.
  SASLSHA1(super.connection,{
    /// The SASL mechanism name
    super.name = 'SCRAM-SHA-1',
  ...
  /// the connection, the challenge, the hash algorithm (SHA-1), and the hash
  /// length (160 bits).
  @override
  String onChallenge({String? challenge}) =>
      Scram().scramResponse(connection!, challenge!, 'SHA-1', 160)!;
